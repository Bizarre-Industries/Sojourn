...
internal struct Redactor: Sendable {
  ...
  internal static let secretPatterns: [(String, String)] = [
    ...
    ("github_pat_[0-9A-Za-z_]{20,}", "<GITHUB_FINE_GRAINED_PAT>"),
    ("ghp_[0-9A-Za-z_]{20,}", "<GITHUB_PAT>"),
    ("gho_[0-9A-Za-z_]{20,}", "<GITHUB_OAUTH>"),
    ("ghu_[0-9A-Za-z_]{20,}", "<GITHUB_APP_USER_TOKEN>"),
    ("ghs_[0-9A-Za-z_\\.]{20,}", "<GITHUB_APP_TOKEN>"),
    ("ghr_[0-9A-Za-z_]{20,}", "<GITHUB_APP_REFRESH_TOKEN>"),
