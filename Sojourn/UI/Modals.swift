...
struct BootstrapView: View {
  ...
  private var activeStep: Int {
    ...
    case .installingBrew, .installingMPM: return 3
    case .installingChezmoi: return 4
    case .installingMas: return 5
    case .ready: return 6
  ...
  private var contentBody: some View {
    ...
    case .installingMPM:
      installingPane(
        ...
        title: "HOMEBREW",
        subtitle: """
          brew bundle is Sojourn's single package backend and declarative source of truth. \
          It natively manages brew, cask, mas, vscode, go, cargo, uv, krew, npm, \
          and tap entries per ADR-0018.
          """,
        progress: 0.60
      )
