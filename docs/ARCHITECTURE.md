...
| §3 Competitive landscape   | `#3-competitive-landscape-findings`                                        | [explain/why-sojourn.md](explain/why-sojourn.md)                                                                                             |
...
| §9 Bootstrap               | `#9-dependency-bootstrap-flow`                                             | [explain/bootstrap-state-machine.md](explain/bootstrap-state-machine.md)                                                                                                       |
...
| §15 v1 scope cut           | `#15-proposed-v1-scope-cut`                                                | [process/implementation-plan.md](process/implementation-plan.md) "Out of scope" + [process/future.md](process/future.md)                               |
...
| §18 Observability          | `#18-observability`                                                        | [explain/observability.md](explain/observability.md)                                                                                                         |
